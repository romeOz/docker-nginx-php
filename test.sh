...
echo "-- Building Nginx + PHP 7.3 image"
...
echo "-- Building Nginx + PHP 7.2 image"
...
echo "-- Building Nginx + PHP 7.1 image"
...
echo
echo
echo "-- Building Nginx + PHP 7.0 image"
...
echo
echo
echo "-- Building Nginx + PHP 5.5 image"
...
echo
echo
echo "-- Building Nginx + PHP 5.3 image"
